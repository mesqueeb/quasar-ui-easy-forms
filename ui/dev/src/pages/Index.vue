<template>
  <q-page padding class="column">
    <q-list dense class="list">
      ...
      <div class="q-my-md">Generate an entire form via just a "schema" object</div>
      <q-item
        v-for="page in pagesEasyForm"
        :key="page.path"
        :to="page.path"
      >
    ...
    <q-list class="row">
        ...
        <q-item clickable tag="a" target="_blank" href="https://github.com/mesqueeb/quasar-ui-easy-forms">
          <q-item-section avatar>
